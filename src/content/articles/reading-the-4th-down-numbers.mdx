...
## What the record will mean

Once the model is live, the sidebar will keep a record of graded calls: situations where the model's recommendation and the coach's choice disagreed, scored by what happened next. It will be a running tally, not a proof. Single games are noisy, and a good process loses plenty of individual bets. The record is meant for watching the sample grow, not for declaring victory in week 3.
